...
<?php include "include/header.php"; ?>
  ...
  <main id="main">
    ...
    <!-- ======= About Section ======= -->
    <section id="about why-us" class="about why-us mt-5">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <!-- <div class="col-lg-4 position-relative about-img" style="background-image: url(assets/img/a1.png) ;background-repeat:no-repeat; margin-top:50px;" data-aos="fade-up" data-aos-delay="150">
          </div> -->
          ...
          <!-- <div class="section-header">
            ...
            <div class="col-lg-6">
              <img src="assets/img/about/Ahilya-photo.webp" style="height:100px; width:100px;" alt="">
          </div> -->
        </div>
        </div>
      </div>
      ...
      <div class="container mt-3" data-aos="fade-up">
       <div class="section-header">
        ...
        <div class="row gy-4">
          <div class="col-lg-8 d-flex offset-lg-4 align-items-center">
            <div class="row gy-4">
              <div class="col-xl-5" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  <!-- <i class="bi bi-file-pdf"></i> -->
                  <div class="text-center">
                  <img src="assets/img/about/Ahilya-photo.webp" style="height:150px; width:150px;" alt="">
                </div>
                  <strong class="mt-2">Ahilya Barge</strong>
                  <span>Director</span>
                </div>
              </div>
              ...
              <div class="col-xl-5" data-aos="fade-up" data-aos-delay="200">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  <div class="text-center">
                  <img src="assets/img/about/Nilesh-picture.webp" style="height:150px; width:150px; alt="">
                </div>
                <strong class="mt-2">Nilesh Barge</strong>
                  <span>COO</span>
                </div>
              </div>
            </div>
