...
<html lang="en" dir="ltr">
  ...
  <!-- About Us Start -->
    ...
    <div class="container">
      ...
      <div class="section-title-wrap text-center">
        <h2 class="title">  Spices for <span class="custom-primary">25 Years</span> a hobbiest for 30</h2>
        <p class="subtitle">
          Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make
          a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting
        </p>
        <a href="contact-us.html" class="btn-custom primary"> Contact Me <i class="fas fa-arrow-right"></i> </a>
      </div>
  ...
  <section class="section section-padding pt-0">
      <div class="container">
        ...
        <div class="row">
         <div class="col-lg-2 col-md-5 col-sm-6 offset-lg-4 text-center">
             <img src="assets/img/about/Ahilya-photo.webp" style="height:150px; width:150px;" alt="">
                <h5>Ahilya Barge</h5>
                <span>Director</span>
          </div>
          <div class="col-lg-2 col-md-5 col-sm-6 text-center">
          <img src="assets/img/about/coo.jpeg" style="height:150px; width:150px;" alt="">
                <h5>Nilesh Barge</h5>
                <span>COO</span>
            </div>
          </div>
